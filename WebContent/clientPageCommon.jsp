...
<%
	...
	application.setAttribute("10.210.24.110", "Ruhul");
	...
	<div class="col s12">
		...
		<div class="row">
			...
			<form action="#" class="col s12">
				<input id="inputmessage" type="text" placeholder="start typing message...." />
				<div class="row">
			...
			<div class="col s12">
				<div class="row">
					<div id="Jekin" class="col s2 m1 red" style="height: 15px; width: 15px;border-radius:50%"></div>
					<div class="col s2 m1">Jekin</div>
					<div id="Ruhul" class="col s2 m1  red" style="height: 15px; width: 15px;border-radius:50%"></div>
					<div class="col s2 m1">Ruhul</div>
			...
			var webSocket = 
      new WebSocket('ws://10.210.24.22:8480/serverpush/websocket/common/<%=userName%>');
